...
flowchart TD
    ...
    Financial[FINANCIAL SERVICE<br/>---<br/>POST /arv<br/>POST /risk-assessment<br/>---<br/>Outputs:<br/>- Property value<br/>- Percentiles P10-P90<br/>- Probabilities (3 metrics)<br/>- Chart metadata (5 distributions)]
    
    Technical[TECHNICAL SERVICE<br/>---<br/>POST /endpoint-to-define<br/>---<br/>Outputs:<br/>- Optimal package<br/>- Technology rankings]
    
    Frontend[FRONTEND UI<br/>---<br/>Display comprehensive<br/>professional analysis<br/>to consultant]
